...
if (isset($_POST["submit"])) {
    ...
    $psw = stripslashes(trim($_POST["password"]));
    ...
    if($rows > 0) {
        ...
        echo "<script>alert('Sorry we did not find a match, try again!'); history.go(-1);</script>";
    }
...
//
//    } else {
//        echo "<script>alert('Sorry we did not find a natch');history.go(-1);</script>";
//    }
}
?>
