    ...
    <div class="row">
        <div style="width: 30%; margin: 25px auto;">
            <form action="addteam.php" method="POST">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Height" name="height" id="height" required>
                </div>
                <div class="form-group">
                    <input class="form-control" type="number" placeholder="Weight" name="weight" id="weight" required>
                </div>
                <div class="form-group">
                    <input class="form-control" type="date" placeholder="Birth" name="birth" id="birth" required>
                </div>
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="College" name="college" id="college" required>
                </div>
                <div class="form-group">
