...
$sql = "INSERT INTO teamsInfo (teamId, division, teamName, cityState, arena, capacity, joined) 
        VALUES ('$teamId', '$division', '$teamName', '$cityState', '$arena', '$capacity', '$year')";
        ...
        <div style="width: 30%; margin: 25px auto;">
            <form action="addteam.php" method="POST">
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Team Id" name="teamId" id="teamId" required>
                </div>
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Division" name="division" id="division" required>
                </div>
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Team Name" name="teamName" id="teamName" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input class="form-control" type="text" placeholder="Arena" name="arena" id="arena">
                </div>
                <div class="form-group">
                    <input class="form-control" type="number" placeholder="Capacity" name="capacity" id="capacity">
                </div>
                <div class="form-group">
                    <input class="form-control" type="number" placeholder="Joined Year" name="year" id="year">
                </div>
                <div class="form-group">
                    <input type="submit" class="btn btn-lg btn-primary btn-block" name="submit" value="Add"/>
                </div>
            </form>
            <a href="teams.php">Go Back</a>
        </div>
    </div>
</div>
